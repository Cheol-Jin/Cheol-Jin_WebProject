...
public class BoardController {
   ...
   /* @ApiOperation(value = "개별 게시글 보기", notes = "개별 게시글 조회한다.")*/
    ...
    public Response getBoard(@PathVariable("orders") Integer id) {
   ...
   /* @ApiOperation(value = "게시글 수정", notes = "게시글을 수정한다.")*/
    ...
    public Response edit(@RequestBody BoardDto boardDto, @PathVariable("orders") Integer id) {
        // 원래 로그인을 하면, User 정보는 세션을 통해서 구하고 주면 되지만,
        // 지금은 핵심 개념을 알기 위해서, JWT 로그인은 생략하고, 임의로 findById 로 유저 정보를 넣어줬습니다.
    ...
    public Response delete(@PathVariable("orders") Integer id) {
